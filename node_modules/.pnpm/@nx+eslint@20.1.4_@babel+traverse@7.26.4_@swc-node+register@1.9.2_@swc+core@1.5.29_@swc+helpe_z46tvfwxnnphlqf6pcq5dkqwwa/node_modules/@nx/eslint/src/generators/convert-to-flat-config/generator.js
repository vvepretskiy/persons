...
function processConvertedConfig(tree, root, source, target, { content, addESLintRC, addESLintJS, }) {
    ...
    (0, devkit_1.removeDependenciesFromPackageJson)(tree, ['@typescript-eslint/eslint-plugin', '@typescript-eslint/parser'], ['@typescript-eslint/eslint-plugin', '@typescript-eslint/parser']);
}
